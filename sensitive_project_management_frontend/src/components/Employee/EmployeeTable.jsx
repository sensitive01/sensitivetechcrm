...
const EmployeeTable = () => {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        setLoading(true);
        const response = await axios.get("https://sensitivetechcrm.onrender.comgetallemployees");
  ...
  const handleEmployeeDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this employee?")) {
      try {
        await axios.delete(`https://sensitivetechcrm.onrender.comdeleteemployee/${id}`);
