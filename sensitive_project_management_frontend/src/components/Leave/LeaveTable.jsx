...
const LeaveTable = () => {
    ...
    useEffect(() => {
        const fetchLeaves = async () => {
            try {
                const response = await axios.get('https://sensitivetechcrm.onrender.comleaves/get-all');
    ...
    const handleDelete = async (leaveId) => {
        if (window.confirm('Are you sure you want to delete this leave?')) {
            try {
                const response = await axios.delete(`https://sensitivetechcrm.onrender.comleaves/delete/${leaveId}`);
