...
const TaskList = () => {
    ...
    useEffect(() => {
      const fetchTasks = async () => {
          try {
              const response = await axios.get('https://sensitivetechcrm.onrender.comtask/getalltask');
    ...
    const handleDelete = async (taskId) => {
        if (window.confirm('Are you sure you want to delete this task?')) {
            try {
                const response = await axios.delete(`https://sensitivetechcrm.onrender.comtask/deletetask/${taskId}`);
