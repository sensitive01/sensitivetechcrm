...
const LeadTable = () => {
    ...
    useEffect(() => {
        const fetchLeads = async () => {
            try {
                const response = await axios.get('https://sensitivetechcrm.onrender.comleads/get-all');
    ...
    const handleDelete = async (leadId) => {
        if (window.confirm('Are you sure you want to delete this lead?')) {
            try {
                const response = await axios.delete(`https://sensitivetechcrm.onrender.comleads/delete/${leadId}`);
